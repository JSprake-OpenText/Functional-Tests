...
SAPGuiSession("Session").SAPGuiWindow("SAP").SAPGuiEdit("*User").Set "s4h_sd_dem" @@ hightlight id_;_1_;_script infofile_;_ZIP::ssf1.xml_;_
SAPGuiSession("Session").SAPGuiWindow("SAP").SAPGuiEdit("*Password").Set "********" @@ hightlight id_;_2_;_script infofile_;_ZIP::ssf1.xml_;_
